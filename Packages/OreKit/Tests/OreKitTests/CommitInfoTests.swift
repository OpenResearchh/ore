...
struct CommitInfoTests {
    @Test func parseLogReadsFieldsAndShortstat() {
        let raw = """
        abcdef0123456789abcdef0123456789abcdef01\u{1f}abcdef0\u{1f}ORE Workbench UI Polish\u{1f}Ada Lovelace\u{1f}2026-08-15T12:00:00Z
         3 files changed, 42 insertions(+), 7 deletions(-)
        1111111111111111111111111111111111111111\u{1f}1111111\u{1f}Follow-up\u{1f}Ada Lovelace\u{1f}2026-08-15T12:01:00Z
